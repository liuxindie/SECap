...
def main(args):
    set_seed(args.seed)  # 或者 args.seed
...
if __name__ == '__main__':
    ...
    parser.add_argument("--retrieval_encoder", type=str, default="vit", help="Visual encoder used for retieving captions")
    parser.add_argument("--captions_path", type=str, default="data/retrieved_caps_vitl14.json", help="JSON file with retrieved captions")
