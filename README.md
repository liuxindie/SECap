...
```
## Acknowledgments
This code utilizes resources from SmallCap: [RitaRamo/smallcap: SmallCap: Lightweight Image Captioning Prompted with Retrieval Augmentation]. We thank the authors for open-sourcing their wonderful project.
